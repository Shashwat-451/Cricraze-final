      ...
      <div class="rca-row">
        ...
        <div class="rca-column-6">
          ...
          <div class="rca-medium-widget rca-padding rca-live-season rca-top-border">
			...
			<?php echo $result['data']['teams'][0]?>
			vs 
			<?php echo $result['data']['teams'][1]?>
			
			<br/><br/>
			<?php
			if(isset($result['score']) && $result['score']!='false'){
				echo $result['data']['score'][0];
			}
			?>	
            ...
            <div class="rca-padding">       
              <h3 class="rca-match-title">
                <a href="/main.html">
                <?php
				  if(isset($result['data']['tosswinner'])){
          ...
          <div class="rca-mini-widget rca-history-info">
			...
			<div class="rca-row">
              ...
              <span class="rca-col"> 
			  <?php
			  if(isset($result['data']['matchWinner'])){
				  echo $result['data']['matchWinner'];
			  }
			  ?>
			  </span>
            </div>
          ...
          <div class="rca-medium-widget rca-top-border ">
            ...
            <div id="tab-41" class="rca-tab-content rca-padding active">
              <div class="rca-batting-score rca-padding">
				...
				$totalO=0;
				$totalR=0;
				foreach($result['data']['score'][0]['scores'] as $list){
